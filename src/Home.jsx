                ...
                >
                 ...
                 >
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        <Link
                            to="/blog/reforme-dpe-2026-coefficient-electrique"
                        ...
                        >
                            <div className="overflow-hidden">
                                <img
                                    ...
                                    alt="Étiquette DPE réforme 2026 nouveau coefficient électrique"
                                    loading="lazy"
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <span className="inline-flex items-center self-start rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold px-3 py-1 mb-3">
                                    Réglementation &amp; DPE · 2 juillet 2026
                                </span>
                                <h3 className="text-xl font-semibold text-gray-900 font-display mb-3 leading-snug">
                                    Réforme DPE 2026 : 850 000 logements reclassés grâce au nouveau coefficient électrique
                                </h3>
                                <p className="text-gray-600 leading-relaxed mb-5 flex-grow">
                                    Depuis le 1er janvier 2026, le coefficient électrique du DPE passe de 2,3 à 1,9.
                                    Ce que ça change pour les propriétaires, bailleurs et vendeurs.
                                </p>
