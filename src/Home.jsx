                ...
                >
                 ...
                 >
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        <Link
                            to="/blog/artisan-rge-2026-guide-complet"
                        ...
                        >
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <span className="inline-flex items-center self-start rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold px-3 py-1 mb-3">
                                    Guide pratique · 24 juillet 2026
                                </span>
                                <h3 className="text-xl font-semibold text-gray-900 font-display mb-3 leading-snug">
                                    Artisan RGE en 2026 : comment trouver et vérifier un professionnel certifié
                                </h3>
                                <p className="text-gray-600 leading-relaxed mb-5 flex-grow">
                                    Sans artisan RGE, aucune aide n'est versée. On vous explique comment vérifier la
                                    certification, les labels à connaître et les pièges à éviter.
                                </p>
