                ...
                >
                 ...
                 >
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        <Link
                            to="/blog/tva-5-5-travaux-renovation-energetique-2026"
                        ...
                        >
                            <div className="overflow-hidden">
                                <img
                                    ...
                                    alt="Travaux d'isolation éligibles à la TVA à 5,5 %"
                                    loading="lazy"
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <span className="inline-flex items-center self-start rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold px-3 py-1 mb-3">
                                    Aides &amp; fiscalité · 14 juillet 2026
                                </span>
                                <h3 className="text-xl font-semibold text-gray-900 font-display mb-3 leading-snug">
                                    TVA à 5,5 % sur les travaux : l'aide sans condition de revenus à ne pas rater
                                </h3>
                                <p className="text-gray-600 leading-relaxed mb-5 flex-grow">
                                    Applicable à tous les propriétaires, la TVA réduite à 5,5 % peut économiser
                                    1 450 € pour 10 000 € de travaux. Démarches simplifiées en 2026 : plus de Cerfa.
                                </p>
