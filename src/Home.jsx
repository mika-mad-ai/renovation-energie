                ...
                >
                 ...
                 >
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        <Link
                            to="/blog/maprimerenov-par-geste-septembre-2026"
                        ...
                        >
                            <div className="overflow-hidden">
                                <img
                                    ...
                                    alt="MaPrimeRénov' 2026 travaux exclus par geste"
                                    loading="lazy"
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                ...
                                <p className="text-gray-600 leading-relaxed mb-5 flex-grow">
                                    Isolation combles, fenêtres, VMC, poêle à bois… dès septembre 2026, ces travaux quittent
                                    le monogeste. Ce qui change, les exceptions et comment agir avant la réforme.
                                </p>
