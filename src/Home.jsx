                ...
                >
                 ...
                 >
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        <Link
                            to="/blog/cumuler-aides-renovation-energetique-2026"
                        ...
                        >
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <span className="inline-flex items-center self-start rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold px-3 py-1 mb-3">
                                    Aides &amp; financement · 28 juil. 2026
                                </span>
                                <h3 className="text-xl font-semibold text-gray-900 font-display mb-3 leading-snug">
                                    Cumuler MaPrimeRénov', CEE et Éco-PTZ en 2026 : mode d'emploi
                                </h3>
                                <p className="text-gray-600 leading-relaxed mb-5 flex-grow">
                                    Ces aides se cumulent — et bien orchestrées, elles couvrent jusqu'à 90 % du
                                    coût de vos travaux. Mode d'emploi et exemple chiffré pour un projet PAC air/eau.
                                </p>
