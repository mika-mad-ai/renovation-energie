                ...
                >
                 ...
                 >
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        <Link
                            to="/blog/panneaux-solaires-photovoltaiques-autoconsommation-2026"
                        ...
                        >
                            <div className="overflow-hidden">
                                <img
                                    ...
                                    alt="Panneaux solaires sur le toit d'une maison"
                                    loading="lazy"
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <span className="inline-flex items-center self-start rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold px-3 py-1 mb-3">
                                    Solaire &amp; autoconsommation · 17 juillet 2026
                                </span>
                                <h3 className="text-xl font-semibold text-gray-900 font-display mb-3 leading-snug">
                                    Panneaux solaires en 2026 : prime supprimée, que faire pour rester rentable ?
                                </h3>
                                <p className="text-gray-600 leading-relaxed mb-5 flex-grow">
                                    Depuis juin 2026, la prime à l'autoconsommation a disparu. TVA à 5,5 %,
                                    tarif de rachat revu et stratégies d'autoconsommation directe : le point complet.
                                </p>
