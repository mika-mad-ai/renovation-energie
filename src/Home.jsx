                ...
                >
                 ...
                 >
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        <Link
                            to="/blog/batterie-stockage-solaire-autoconsommation-2026"
                        ...
                        >
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <span className="inline-flex items-center self-start rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold px-3 py-1 mb-3">
                                    Énergie solaire · 19 sept. 2026
                                </span>
                                <h3 className="text-xl font-semibold text-gray-900 font-display mb-3 leading-snug">
                                    Batterie de stockage solaire en 2026 : rentabilité et aides
                                </h3>
                                <p className="text-gray-600 text-sm flex-grow">
                                    La chute du tarif de rachat change tout : stocker votre production solaire vaut désormais 18 fois plus que la revendre. Prix, aides disponibles et retour sur investissement.
                                </p>
