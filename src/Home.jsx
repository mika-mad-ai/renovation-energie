                        ...
                        >
                            <div className="overflow-hidden">
                                <img
                                    ...
                                    alt="Immeuble en copropriété rénové"
                                    loading="lazy"
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <span className="inline-flex items-center self-start rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold px-3 py-1 mb-3">
                                    Copropriétés &amp; aides · 18 juillet 2026
                                </span>
                                ...
                                <p className="text-gray-600 leading-relaxed mb-5 flex-grow">
                                    Jusqu'à 45 % de subvention pour rénover les parties communes de votre immeuble.
                                    Conditions, montants, procédure et aides complémentaires : tout ce que le syndic
                                    doit savoir en 2026.
                                </p>
