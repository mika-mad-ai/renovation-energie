                ...
                >
                 ...
                 >
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        <Link
                            to="/blog/fenetres-double-vitrage-aides-2026"
                        ...
                        >
                            <div className="overflow-hidden">
                                <img
                                    ...
                                    alt="Remplacement de fenêtres en double vitrage"
                                    loading="lazy"
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <span className="inline-flex items-center self-start rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold px-3 py-1 mb-3">
                                    Isolation &amp; menuiseries · 15 juillet 2026
                                </span>
                                <h3 className="text-xl font-semibold text-gray-900 font-display mb-3 leading-snug">
                                    Fenêtres et double vitrage en 2026 : aides, prix et critères techniques
                                </h3>
                                <p className="text-gray-600 leading-relaxed mb-5 flex-grow">
                                    MaPrimeRénov', CEE, TVA à 5,5 % : tout ce qu'il faut savoir pour financer
                                    le remplacement de vos fenêtres et le critère Uw ≤ 1,3 W/m²K à vérifier.
                                </p>
