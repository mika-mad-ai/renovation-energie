                ...
                >
                 ...
                 >
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        <Link
                            to="/blog/chaudiere-granules-bois-2026-prix-aides"
                        ...
                        >
                            <div className="overflow-hidden">
                                <img
                                    ...
                                    alt="Chaudière à granulés de bois"
                                    loading="lazy"
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <span className="inline-flex items-center self-start rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold px-3 py-1 mb-3">
                                    Chauffage &amp; aides · 20 juillet 2026
                                </span>
                                <h3 className="text-xl font-semibold text-gray-900 font-display mb-3 leading-snug">
                                    Chaudière à granulés en 2026 : prix, aides et alternatives au gaz
                                </h3>
                                <p className="text-gray-600 leading-relaxed mb-5 flex-grow">
                                    MaPrimeRénov' par geste exclue depuis janvier 2026 : CEE, TVA 5,5 %,
                                    Éco-PTZ et rénovation d'ampleur — toutes les aides encore disponibles pour financer votre biomasse.
                                </p>
