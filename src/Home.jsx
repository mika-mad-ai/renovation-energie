                ...
                >
                 ...
                 >
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        <Link
                            to="/blog/isolation-combles-2026-aides-prix"
                        ...
                        >
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <span className="inline-flex items-center self-start rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold px-3 py-1 mb-3">
                                    Isolation &amp; aides · 9 juillet 2026
                                </span>
                                <h3 className="text-xl font-semibold text-gray-900 font-display mb-3 leading-snug">
                                    Isolation des combles en 2026 : ce qui a changé avec MaPrimeRénov'
                                </h3>
                                <p className="text-gray-600 leading-relaxed mb-5 flex-grow">
                                    Depuis janvier 2026, les combles perdus ne sont plus finançables par le parcours
                                    par geste. CEE, TVA réduite, rénovation d'ampleur : on fait le point sur les aides
