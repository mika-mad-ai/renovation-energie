                ...
                >
                 ...
                 >
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        <Link
                            to="/blog/raccordement-reseau-chaleur-urbain-2026"
                        ...
                        >
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <span className="inline-flex items-center self-start rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold px-3 py-1 mb-3">
                                    Chauffage · 22 sept. 2026
                                </span>
                                <h3 className="text-xl font-semibold text-gray-900 font-display mb-3 leading-snug">
                                    Réseau de chaleur urbain : l'un des rares gestes encore aidés seuls en 2026
                                </h3>
                                <p className="text-gray-600 text-sm flex-grow">
                                    Depuis la réforme du 1er septembre 2026, le raccordement à un réseau de chaleur urbain reste éligible à MaPrimeRénov' sans rénovation globale. Coûts, aides et comment vérifier votre adresse.
                                </p>
