                        ...
                        >
                            <div className="overflow-hidden">
                                <img
                                    ...
                                    alt="Immeuble résidentiel rénové — propriétaire bailleur"
                                    loading="lazy"
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <span className="inline-flex items-center self-start rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold px-3 py-1 mb-3">
                                    Aides bailleurs · 21 juillet 2026
                                </span>
                                <h3 className="text-xl font-semibold text-gray-900 font-display mb-3 leading-snug">
                                    MaPrimeRénov' pour les propriétaires bailleurs en 2026 — conditions, montants et obligations
                                </h3>
                                <p className="text-gray-600 leading-relaxed mb-5 flex-grow">
                                    G interdit à la location depuis 2025, F en 2028 : ce que les bailleurs peuvent obtenir
                                    avec MaPrimeRénov', le déficit foncier doublé et les CEE pour rénover avant les échéances.
                                </p>
