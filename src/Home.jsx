                ...
                >
                 ...
                 >
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        <Link
                            to="/blog/loi-relance-logement-2026-passoires-location"
                        ...
                        >
                            <div className="overflow-hidden">
                                <img
                                    ...
                                    alt="Maison à rénover — loi Relance logement 2026"
                                    loading="lazy"
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <span className="inline-flex items-center self-start rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold px-3 py-1 mb-3">
                                    Réglementation &amp; bailleurs · 4 juillet 2026
                                </span>
                                <h3 className="text-xl font-semibold text-gray-900 font-display mb-3 leading-snug">
                                    Loi Relance logement 2026 : relouer une passoire thermique sous engagement de travaux
                                </h3>
                                <p className="text-gray-600 leading-relaxed mb-5 flex-grow">
                                    700 000 logements F et G pourraient revenir sur le marché locatif. On vous explique
                                    les conditions, les délais et ce qu'il faut faire dès maintenant.
                                </p>
