                        ...
                        >
                            <div className="overflow-hidden">
                                <img
                                    ...
                                    alt="Financement rénovation énergétique sans avance de fonds"
                                    loading="lazy"
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <span className="inline-flex items-center self-start rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold px-3 py-1 mb-3">
                                    Financement &amp; aides · 23 juillet 2026
                                </span>
                                <h3 className="text-xl font-semibold text-gray-900 font-display mb-3 leading-snug">
                                    Prêt Avance Rénovation (PAR) 2026 — rénover sans avancer un euro
                                </h3>
                                <p className="text-gray-600 leading-relaxed mb-5 flex-grow">
                                    Pas de liquidités pour rénover ? Le PAR vous permet d'emprunter jusqu'à 50 000 €
                                    et de ne rembourser le capital qu'à la vente de votre bien. Guide complet.
                                </p>
