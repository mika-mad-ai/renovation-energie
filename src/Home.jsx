                ...
                >
                 ...
                 >
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        <Link
                            to="/blog/renovation-ampleur-parcours-accompagne-2026"
                        ...
                        >
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <span className="inline-flex items-center self-start rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold px-3 py-1 mb-3">
                                    Aides &amp; financement · 11 juillet 2026
                                </span>
                                <h3 className="text-xl font-semibold text-gray-900 font-display mb-3 leading-snug">
                                    Rénovation d'ampleur en 2026 : le guide du parcours accompagné
                                </h3>
                                <p className="text-gray-600 leading-relaxed mb-5 flex-grow">
                                    Conditions, montants MaPrimeRénov', rôle de l'Accompagnateur Rénov' et
                                    étapes clés pour décrocher jusqu'à 80 % d'aides sur votre rénovation globale.
                                </p>
