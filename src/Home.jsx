                        ...
                        >
                            <div className="overflow-hidden">
                                <img
                                    ...
                                    alt="Isolation d'un vide sanitaire sous plancher"
                                    loading="lazy"
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <span className="inline-flex items-center self-start rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold px-3 py-1 mb-3">
                                    Isolation &amp; aides · 16 juillet 2026
                                </span>
                                <h3 className="text-xl font-semibold text-gray-900 font-display mb-3 leading-snug">
                                    Isolation du plancher bas en 2026 — vide sanitaire, prix et aides
                                </h3>
                                <p className="text-gray-600 leading-relaxed mb-5 flex-grow">
                                    Le geste d'isolation le plus oublié. Techniques, prix au m², MaPrimeRénov'
                                    et CEE : tout ce qu'il faut savoir pour se lancer.
                                </p>
