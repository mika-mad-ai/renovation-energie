                ...
                >
                 ...
                 >
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        <Link
                            to="/blog/maprimerenov-reforme-septembre-2026"
                        ...
                        >
                            <div className="overflow-hidden">
                                <img
                                    ...
                                    alt="Réforme MaPrimeRénov septembre 2026"
                                    loading="lazy"
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <span className="inline-flex items-center self-start rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold px-3 py-1 mb-3">
                                    Aides &amp; financement · 8 juillet 2026
                                </span>
                                ...
                                <p className="text-gray-600 leading-relaxed mb-5 flex-grow">
                                    Nouveaux plafonds, travaux supprimés, condition sortie du gaz : tout ce qu'il faut
                                    savoir sur la réforme présentée le 2 juillet 2026 pour adapter votre projet.
                                </p>
