                ...
                >
                 ...
                 >
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        <Link
                            to="/blog/radiateurs-inertie-convecteurs-aides-2026"
                        ...
                        >
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <span className="inline-flex items-center self-start rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold px-3 py-1 mb-3">
                                    Chauffage · 18 sept. 2026
                                </span>
                                <h3 className="text-xl font-semibold text-gray-900 font-display mb-3 leading-snug">
                                    Radiateurs à inertie : remplacer ses vieux convecteurs et toucher la prime CEE
                                </h3>
                                <p className="text-gray-600 text-sm flex-grow">
                                    Prime CEE, TVA réduite, éco-PTZ : tout ce qu'il faut savoir pour changer ses convecteurs électriques et réduire sa facture de chauffage en 2026.
                                </p>
