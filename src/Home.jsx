                ...
                >
                 ...
                 >
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        <Link
                            to="/blog/accompagnateur-renov-2026-guide"
                        ...
                        >
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <span className="inline-flex items-center self-start rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold px-3 py-1 mb-3">
                                    Aides &amp; accompagnement · 19 juil. 2026
                                </span>
                                <h3 className="text-xl font-semibold text-gray-900 font-display mb-3 leading-snug">
                                    Mon Accompagnateur Rénov' en 2026 : rôle, obligation et comment bien choisir
                                </h3>
                                <p className="text-gray-600 leading-relaxed mb-5 flex-grow">
                                    Obligatoire pour tout parcours accompagné MaPrimeRénov', le MAR agréé peut être
                                    pris en charge jusqu'à 100 % pour les ménages modestes. Mode d'emploi complet.
                                </p>
