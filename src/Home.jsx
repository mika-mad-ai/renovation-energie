                ...
                >
                 ...
                 >
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        <Link
                            to="/blog/maprimerenov-2026-mode-emploi-dossier"
                        ...
                        >
                            <div className="overflow-hidden">
                                <img
                                    ...
                                    alt="Maison rénovée éligible à MaPrimeRénov'"
                                    loading="lazy"
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <span className="inline-flex items-center self-start rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold px-3 py-1 mb-3">
                                    Aides &amp; financement · 29 juillet 2026
                                </span>
                                <h3 className="text-xl font-semibold text-gray-900 font-display mb-3 leading-snug">
                                    MaPrimeRénov' 2026 : guide pratique pour déposer votre dossier
                                </h3>
                                <p className="text-gray-600 leading-relaxed mb-5 flex-grow">
                                    Rendez-vous France Rénov' obligatoire, nouveaux montants et démarches pas à pas :
                                    tout ce qu'il faut savoir pour obtenir votre prime en 2026.
                                </p>
