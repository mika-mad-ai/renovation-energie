                        ...
                        >
                            <div className="overflow-hidden">
                                <img
                                    ...
                                    alt="Système de ventilation double flux dans un logement"
                                    loading="lazy"
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <span className="inline-flex items-center self-start rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold px-3 py-1 mb-3">
                                    Ventilation &amp; qualité de l'air · 10 juillet 2026
                                </span>
                                <h3 className="text-xl font-semibold text-gray-900 font-display mb-3 leading-snug">
                                    VMC double flux en 2026 : prix, aides et ce qui a changé depuis janvier
                                </h3>
                                <p className="text-gray-600 leading-relaxed mb-5 flex-grow">
                                    Depuis janvier 2026, la VMC double flux doit être couplée à de l'isolation pour
                                    bénéficier de MaPrimeRénov'. Prix, CEE, TVA à 5,5 % : le guide complet.
                                </p>
