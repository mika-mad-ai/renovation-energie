...
import ArticleMaprimeRenovCoproprietes from './Article-maprimerenov-coproprietes-2026';
import './App.css';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/blog/maprimerenov-coproprietes-2026" element={<ArticleMaprimeRenovCoproprietes />} />
    </Routes>
  );
}
