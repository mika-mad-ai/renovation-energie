...
import ArticleIsolationPlancherBas from './Article-isolation-plancher-bas-vide-sanitaire-2026';
import './App.css';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/blog/isolation-plancher-bas-vide-sanitaire-2026" element={<ArticleIsolationPlancherBas />} />
    </Routes>
  );
}
