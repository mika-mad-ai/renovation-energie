...
import ArticleMaPrimeRenovBailleur from './Article-maprimerenov-proprietaire-bailleur-2026';
import './App.css';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/blog/maprimerenov-proprietaire-bailleur-2026" element={<ArticleMaPrimeRenovBailleur />} />
    </Routes>
  );
}
