...
import ArticleMaPrimeRenovReforme from './Article-maprimerenov-reforme-septembre-2026';
import './App.css';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/blog/maprimerenov-reforme-septembre-2026" element={<ArticleMaPrimeRenovReforme />} />
    </Routes>
  );
}
