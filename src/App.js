...
import ArticlePacGeothermique from './Article-pac-geothermique-sol-eau-prix-aides-2026';
import './App.css';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/blog/pac-geothermique-sol-eau-prix-aides-2026" element={<ArticlePacGeothermique />} />
    </Routes>
  );
}
