...
import ArticleIsolationMursIteIti2026 from './Article-isolation-murs-ite-iti-2026';
import './App.css';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/blog/isolation-murs-ite-iti-2026" element={<ArticleIsolationMursIteIti2026 />} />
    </Routes>
  );
}
