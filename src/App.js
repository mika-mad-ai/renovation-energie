...
import ArticleSortirDuFioul from './Article-sortir-du-fioul-2026-aides-alternatives';
import './App.css';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/blog/sortir-du-fioul-2026-aides-alternatives" element={<ArticleSortirDuFioul />} />
    </Routes>
  );
}
