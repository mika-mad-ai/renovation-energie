...
import ArticleMaPrimeRenov2026ModeEmploi from './Article-maprimerenov-2026-mode-emploi-dossier';
import './App.css';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/blog/maprimerenov-2026-mode-emploi-dossier" element={<ArticleMaPrimeRenov2026ModeEmploi />} />
    </Routes>
  );
}
