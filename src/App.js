...
import ArticleRenovationAmpleur2026 from './Article-renovation-ampleur-parcours-accompagne-2026';
import './App.css';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/blog/renovation-ampleur-parcours-accompagne-2026" element={<ArticleRenovationAmpleur2026 />} />
    </Routes>
  );
}
