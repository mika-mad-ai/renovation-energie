...
import ArticlePanneauxSolaires2026 from './Article-panneaux-solaires-photovoltaiques-autoconsommation-2026';
import './App.css';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/blog/panneaux-solaires-photovoltaiques-autoconsommation-2026" element={<ArticlePanneauxSolaires2026 />} />
    </Routes>
  );
}
