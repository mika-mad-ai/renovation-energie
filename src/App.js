...
import ArticleLoiRelanceLogement from './Article-loi-relance-logement-2026-passoires-location';
import './App.css';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/blog/loi-relance-logement-2026-passoires-location" element={<ArticleLoiRelanceLogement />} />
    </Routes>
  );
}
