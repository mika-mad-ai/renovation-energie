...
import ArticleChauffeEauThermodynamique from './Article-chauffe-eau-thermodynamique-aides-2026';
import './App.css';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/blog/chauffe-eau-thermodynamique-aides-2026" element={<ArticleChauffeEauThermodynamique />} />
    </Routes>
  );
}
