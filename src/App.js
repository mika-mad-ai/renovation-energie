...
import ArticleFenetresDoubleVitrage2026 from './Article-fenetres-double-vitrage-aides-2026';
import './App.css';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/blog/fenetres-double-vitrage-aides-2026" element={<ArticleFenetresDoubleVitrage2026 />} />
    </Routes>
  );
}
