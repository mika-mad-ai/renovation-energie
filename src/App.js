...
import ArticleAccompagnateurRenov from './Article-accompagnateur-renov-2026-guide';
import './App.css';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/blog/accompagnateur-renov-2026-guide" element={<ArticleAccompagnateurRenov />} />
    </Routes>
  );
}
