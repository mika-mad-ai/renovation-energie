...
import ArticlePlancherChauffantEau from './Article-plancher-chauffant-eau-prix-aides-2026';
import './App.css';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/blog/plancher-chauffant-eau-prix-aides-2026" element={<ArticlePlancherChauffantEau />} />
    </Routes>
  );
}
