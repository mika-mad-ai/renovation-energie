...
import ArticleChaudiereGranulesBois2026 from './Article-chaudiere-granules-bois-2026';
import './App.css';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/blog/chaudiere-granules-bois-2026-prix-aides" element={<ArticleChaudiereGranulesBois2026 />} />
    </Routes>
  );
}
