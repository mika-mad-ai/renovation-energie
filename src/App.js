...
import ArticlePretAvanceRenovationPAR from './Article-pret-avance-renovation-par-2026';
import './App.css';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/blog/pret-avance-renovation-par-2026" element={<ArticlePretAvanceRenovationPAR />} />
    </Routes>
  );
}
