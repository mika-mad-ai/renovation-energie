...
import ArticleCumulerAidesRenovationEnergetique2026 from './Article-cumuler-aides-renovation-energetique-2026';
import './App.css';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/blog/cumuler-aides-renovation-energetique-2026" element={<ArticleCumulerAidesRenovationEnergetique2026 />} />
    </Routes>
  );
}
