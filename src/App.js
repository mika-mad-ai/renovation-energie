...
import ArticlePassoiresThermiquesLocation from './Article-passoires-thermiques-location-loi-2026';
import './App.css';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/blog/passoires-thermiques-location-loi-2026" element={<ArticlePassoiresThermiquesLocation />} />
    </Routes>
  );
}
