...
import ArticleRefomeDPE2026 from './Article-reforme-dpe-2026-coefficient-electrique';
import './App.css';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/blog/reforme-dpe-2026-coefficient-electrique" element={<ArticleRefomeDPE2026 />} />
    </Routes>
  );
}
