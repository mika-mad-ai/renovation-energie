...
import ArticleMaPrimeRenovParGeste from './Article-maprimerenov-par-geste-septembre-2026';
import './App.css';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/blog/maprimerenov-par-geste-septembre-2026" element={<ArticleMaPrimeRenovParGeste />} />
    </Routes>
  );
}
