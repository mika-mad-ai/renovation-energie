...
import ArticleMaprimerenovTravauxExclus2026 from './Article-maprimerenov-travaux-exclus-2026';
import './App.css';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/blog/maprimerenov-travaux-exclus-2026" element={<ArticleMaprimerenovTravauxExclus2026 />} />
    </Routes>
  );
}
